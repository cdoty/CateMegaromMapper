...
callBankFunction_:	public	callBankFunction_
	...
	ld		a, b
	dec		a					; Subtract one from bank number since Bank 0 is stored at the end of the rom.
	
	ld		(currentBank), a	; Update current bank	
	ld		hl, $FFF8
	add		a, l
	ld		l, a
	ld		a, (hl)				; Select new bank

	ld		a, e				; Select the function to run
	call	$C000				; Jump to the call table at the start of bank 1
